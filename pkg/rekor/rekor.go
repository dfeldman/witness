...
type IRekorOperations interface {
	...
	GetTlogEntry(uuid string) (*models.LogEntryAnon, error)
	FindTLogEntriesByPayload(payload []byte) (uuids []string, err error)
}
...
func (r *wrappedRekorClient) FindTLogEntriesByPayload(payload []byte) (uuids []string, err error) {
